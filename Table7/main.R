...
SCRIPT_DIR <- "/Users/ruting/Documents/macbook/PcBack/32_CARDI/00_Submit/Table7"
setwd(SCRIPT_DIR)
...
# - CARDI predictor choices:
#   "CARDI_1P_M", "CARDI_5P_M", "CARDI_10P_M",
#   "CARDI_1P_LogDiff_M", "CARDI_5P_LogDiff_M", "CARDI_10P_LogDiff_M".
# - HC firm-month dependent-variable choices:
#   "Rela_vola_Return", "Rela_vola_ExReturn", "Rela_vola_PurReturn".
# - Predictability scope choices:
#   "firm", "pool", "both".
# - Firm-level specification choices:
#   "NoControls", "ControlsFirmFE",
#   "ControlsFirmFEYearTrend", "ControlsFirmFEYearFE".
cfg$predictability$scope <- "firm"
cfg$predictability$predictor_family <- "cardi"
cfg$predictability$predictor_vars <- c(
  "CARDI_1P_M",
  "CARDI_5P_M",
  "CARDI_10P_M"
)
cfg$predictability$dependent_vars <- c(
  "Rela_vola_ExReturn",
  "Rela_vola_PurReturn"
)
cfg$predictability$specifications <- c(
  "NoControls",
