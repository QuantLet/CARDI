...
SCRIPT_DIR <- "/Users/ruting/Documents/macbook/PcBack/32_CARDI/00_Submit/Figure1"
setwd(SCRIPT_DIR)

# Relative path - looks inside SCRIPT_DIR
CARDI <- read_excel("Month_CARDI.xlsx")
LCPremium = readRDS("portfolio_premiums_monthly.rds")
...
png(paste0("Intro_CarbonPremia_Month.png"), width = 900, height = 600, bg = "transparent")
