# Predictability stage config helpers.
# This stage reads its input from 00_Submit/Table4/Output/<frequency>.

predictability_table4_dir <- function() {
  ...
  if (basename(cwd) == "03_predictability") {
